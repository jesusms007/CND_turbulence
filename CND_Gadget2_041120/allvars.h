...
#define galactic_radius (8.0/unit_lenght_in_pc) ///// half box size GC simulation
...
#define number_of_grids 4 ///  (galactic_radius / cloud_radius)
...
#define number_of_grids3d (number_of_grids*number_of_grids*number_of_grids)
