...
//////////////Salas Mod . NOV 23, 2016////////
struct physgrid
    cloudgrid;

struct physgrid_box
    galactic_grid[number_of_grids];

double *turb_data_array0;
double *turb_data_array1;
double *turb_data_array2;
double *turb_data_array3;
double *turb_data_array4;
double *turb_data_array5;
double *turb_data_array6;
double *turb_data_array7;
double *turb_data_array8;
double *turb_data_array9;
FILE *turb_out;

int *file_of_each_grid;
