...
void set_units(void)
{
  ...
  All.UnitEnergy_in_cgs = All.UnitMass_in_g * pow(All.UnitLength_in_cm, 2) / pow(All.UnitTime_in_s, 2);
    ...
    All.ExternalPressure = All.ExternalPressure / All.UnitPressure_in_cgs;
    #endif
    /////SALAS MOD, FEB 7, 2017/////
    #ifdef DRIVING
    All.TurbEnergyIn = All.TurbEnergyIn / All.UnitEnergy_in_cgs;
    #endif
    //// SALAS MOD MAY 3 2018
    All.OmegaBar = ( (All.OmegaBar/kpc_to_km) * All.UnitTime_in_s ) ;// convert to code units
    //////////////////////////////////
  ...
  if(ThisTask == 0)
    {
      ...
      printf("UnitEnergy_in_cgs = %g \n", All.UnitEnergy_in_cgs);
        /////SALAS MOD, OCT 3, 2016////
        printf("UnitPressure_in_cgs = %g \n", All.UnitPressure_in_cgs);
        #ifdef EXTERNALPRESSURE
        printf("External Pressure in cgs = %g \n", All.ExternalPressure * All.UnitPressure_in_cgs);
        #endif
        #ifdef DRIVING
        printf("Input Turbulent Energy in cgs = %g \n", All.TurbEnergyIn * All.UnitEnergy_in_cgs);
        printf("Turbulence dependance = %d \n", All.DensityDepenTurb);
        #endif
        #ifdef ROTATING_BAR ///SALAS MOD MAY 3 2018
        printf("Rotating Bar Pattern Speed = %g km/(s kpc)\n", All.OmegaBar * kpc_to_km / All.UnitTime_in_s);
        #endif
        //////////////////////////////
      printf("\n");
    }
...
void open_outputfiles(void)
{
  char mode[2], buf[200];
     ...
     ///SALAS MOD MARCH 3, 2017
    /*
   #ifdef TURB_FILES
   sprintf(buf, "%s%d_%s", All.OutputDir, ThisTask, All.OutTestTurbFile);
  ...
  if(ThisTask == 0)		/* read parameter file on process 0 */
    {
      ...
      id[nt++] = DOUBLE;
        ...
        ///////SALAS MOD. FEB 6, 2017
        //#ifdef DRIVING
        strcpy(tag[nt], "DensityDepenTurb");
        addr[nt] = &All.DensityDepenTurb;
        id[nt++] = INT;
        
        strcpy(tag[nt], "TurbEnergyIn");
        addr[nt] = &All.TurbEnergyIn;
        id[nt++] = DOUBLE;
        
        strcpy(tag[nt], "OutTestTurbFile");
        addr[nt] = All.OutTestTurbFile;
        id[nt++] = STRING;
        //#endif
        /////SALAS MOD, SEPT 29, 2016
        strcpy(tag[nt], "ExternalPressure");
        addr[nt] = &All.ExternalPressure;
        id[nt++] = DOUBLE;
        ////////////////////
        /////SALAS MOD, JULY 3, 2017
        strcpy(tag[nt], "OmegaBar");
        addr[nt] = &All.OmegaBar;
        id[nt++] = DOUBLE;
        ////////////////////
