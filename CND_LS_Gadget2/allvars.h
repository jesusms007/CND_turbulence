...
#else
#define  GAMMA         (7.0/5.0)   /*!< adiabatic index of simulated gas */  ////SALAS MOD diatomic gas
#endif
///////////////////////////////////////////////////
////////////SALAS MOD ////////////////////////////
/////MY OWN DEFINITIONS ON THE MAKEFILE //////////

///////////////// Turbulence definitions ///////////////////
#define unit_lenght_in_pc 0.1 /// pc
#define grid_size 129
#define cloud_radius (2.0/unit_lenght_in_pc)   ///half box size 1 grid
#define galactic_radius (4.0/unit_lenght_in_pc) ///// half box size GC simulation
#define delta ( 2.0*cloud_radius/128.0 ) ///2*cloud_radius/grid_size-1   "resolution"
#define dim 3
#define size_turb (grid_size*grid_size*grid_size)
#define sec2 (dim*size_turb) //// 3* 128^3
#define number_of_grids 2 ///  (galactic_radius / cloud_radius) in one dimension

///////////////// TURBULENT FILES HOLDER ARRAY /////////////////
#define seed_ran3 -4528372
#define Nturbfiles 10
extern double *turb_data_array0;
extern double *turb_data_array1;
extern double *turb_data_array2;
extern double *turb_data_array3;
extern double *turb_data_array4;
extern double *turb_data_array5;
extern double *turb_data_array6;
extern double *turb_data_array7;
extern double *turb_data_array8;
extern double *turb_data_array9;

//////////////////////////////////
//extern FILE *turb_out;// = fopen("/Users/jesussalas/Downloads/FEB_AQUILA/test_turbulence/feb24/turbout.txt", "r");
///////////////////////////////////////////////////

///////////////// HOLDER STRUCTURES FOR PHYSICAL GRIDS /////////////////
extern struct physgrid
{
...
///////////////////////////// CND VERSION////////
extern struct physgrid_box /// x-y axes
{
    double grid[grid_size];
    long idum;
}
galactic_grid[number_of_grids], //// number of grids
galactic_grid_z; //// number of grids

////////////////////////////////////////////////////////////////////

///////////////// ARRAY FOR IDENTIFYING EACH GRID /////////////////
#define number_of_grids3d (number_of_grids*number_of_grids)
extern int *file_of_each_grid;
//////////////////////////////////

extern int DriveFlag;
extern int Alternating ;
...
extern double EPOTGC;
extern double etot_sys;
extern double omega_bar;
///............................///

///....galactic potential definitions...../// ///SALAS MOD 2/17/17
#define pc_to_km 3.085678e13 ///// 1 pc = 3.08e13 km
#define kpc_to_km (pc_to_km*1000.0)
#define pc_to_cm 3.085678e18 /// 1 pc = 3.09e18 cm
#define km_to_pc 1.0/pc_to_km
#define Myrs_in_s 3.155e13     // 1 Myr in seconds
/////.................................///////
...
#define  MY_PI             3.1415927    ///SALAS MOD 3/17/16
...
////    SALAS MOD.APRIL 10, 2017 -- SEE ALSO BEGRUN.C == read_parameter_file function
    int DensityDepenTurb;
    double TurbEnergyIn;
    char OutTestTurbFile[MAXLEN_FILENAME];
    double ExternalPressure; /////ADDED SEPT 29, 2016
    double OmegaBar; /////SALAS MOD JULY 3 2017
//////
}
...
#endif
    #ifdef  DRIVING ////SALAS MOD. FEB 9 2017
    double TURB_VEL[3];
    #endif
}
