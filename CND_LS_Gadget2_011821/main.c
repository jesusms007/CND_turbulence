...
{  
  ...
  MPI_Comm_size(MPI_COMM_WORLD, &NTask);
   ...
   if(ThisTask == 0) ////CHECKIN MACHINES
    {
        #ifdef DRIVING
        printf("\nCompiled with turbulent support\n");
        #endif
        
        #ifdef NOGRAVITY ////SALAS MOD MAY 3 2018
        printf("Compiled with NO SELF GRAVITY\n");
        #endif
        
        #ifdef GRAVITY_GALAXY
        printf("Compiled with galactic potential\n");
            #ifdef ROTATING_BAR
            printf("Compiled with rotating bar\n");
            #endif
        #endif
        
        #ifdef ADD_VAZQUEZ_COOLING
        printf("Compiled with cooling\n");
        #endif
        
        #ifdef EXTERNALPRESSURE
        printf("Compiled with external pressure\n");
        #endif
        
        
        #ifdef COMET
         printf("Compiled on Comet\n");
        #endif
        
        #ifdef HOFFMAN2
        printf("Compiled on Hoffman2\n");
        #endif
        
        #ifdef AQUILA
        printf("Compiled on Aquila\n");
        #endif

        #ifdef DYNAMIC
        printf("Compiled on Dynamic \n");
        #endif
        
        #ifdef MAC
        printf("Compiled on My laptop \n");
        #endif
    ...
    #ifdef DRIVING
    /////////////////// SALAS EDIT, DEC 13, 2016 ///////////////////////
    const char *normal_tur_file0;// = "/Volumes/PHD/TURBULENTFILES/n_4/128/t0_vn_grid.txt";
    const char *normal_tur_file1;// = "/Volumes/PHD/TURBULENTFILES/n_4/128/t1_vn_grid.txt";
    const char *normal_tur_file2;// = "/Volumes/PHD/TURBULENTFILES/n_4/128/t2_vn_grid.txt";
    const char *normal_tur_file3;// = "/Volumes/PHD/TURBULENTFILES/n_4/128/t3_vn_grid.txt";
    const char *normal_tur_file4;// = "/Volumes/PHD/TURBULENTFILES/n_4/128/t4_vn_grid.txt";
    const char *normal_tur_file5;// = "/Volumes/PHD/TURBULENTFILES/n_4/128/t5_vn_grid.txt";
    const char *normal_tur_file6;// = "/Volumes/PHD/TURBULENTFILES/n_4/128/t6_vn_grid.txt";
    const char *normal_tur_file7;// = "/Volumes/PHD/TURBULENTFILES/n_4/128/t7_vn_grid.txt";
    const char *normal_tur_file8;// = "/Volumes/PHD/TURBULENTFILES/n_4/128/t8_vn_grid.txt";
    const char *normal_tur_file9;// = "/Volumes/PHD/TURBULENTFILES/n_4/128/t9_vn_grid.txt";
    /*
    const char *normal_tur_file10;
    const char *normal_tur_file11;
    const char *normal_tur_file12;
    const char *normal_tur_file13;
    const char *normal_tur_file14;
    const char *normal_tur_file15;
    const char *normal_tur_file16;
    const char *normal_tur_file17;
    const char *normal_tur_file18;
    const char *normal_tur_file19;
     */
       #ifdef DYNAMIC
            normal_tur_file0 = "/Volumes/PHD/TURBULENTFILES/n_4/128/t0_vn_grid.txt";
            normal_tur_file1 = "/Volumes/PHD/TURBULENTFILES/n_4/128/t1_vn_grid.txt";
            normal_tur_file2 = "/Volumes/PHD/TURBULENTFILES/n_4/128/t2_vn_grid.txt"; ///using k=2-128
            normal_tur_file3 = "/Volumes/PHD/TURBULENTFILES/n_4/128/t3_vn_grid.txt";
            normal_tur_file4 = "/Volumes/PHD/TURBULENTFILES/n_4/128/t4_vn_grid.txt";
            normal_tur_file5 = "/Volumes/PHD/TURBULENTFILES/n_4/128/t5_vn_grid.txt";
            normal_tur_file6 = "/Volumes/PHD/TURBULENTFILES/n_4/128/t6_vn_grid.txt";
            normal_tur_file7 = "/Volumes/PHD/TURBULENTFILES/n_4/128/t7_vn_grid.txt";
            normal_tur_file8 = "/Volumes/PHD/TURBULENTFILES/n_4/128/t8_vn_grid.txt";
            normal_tur_file9 = "/Volumes/PHD/TURBULENTFILES/n_4/128/t9_vn_grid.txt";
        #endif
    
        #ifdef AQUILA
    normal_tur_file0 = "/Volumes/ThunderBay/JESUS_HAPPYCLOUDS/129/t0_vn_grid.txt";
    normal_tur_file1 = "/Volumes/ThunderBay/JESUS_HAPPYCLOUDS/129/t1_vn_grid.txt";///using k=2-129
    normal_tur_file2 = "/Volumes/ThunderBay/JESUS_HAPPYCLOUDS/129/t2_vn_grid.txt";
    normal_tur_file3 = "/Volumes/ThunderBay/JESUS_HAPPYCLOUDS/129/t3_vn_grid.txt";
    normal_tur_file4 = "/Volumes/ThunderBay/JESUS_HAPPYCLOUDS/129/t4_vn_grid.txt";
    normal_tur_file5 = "/Volumes/ThunderBay/JESUS_HAPPYCLOUDS/129/t5_vn_grid.txt";
    normal_tur_file6 = "/Volumes/ThunderBay/JESUS_HAPPYCLOUDS/129/t6_vn_grid.txt";
    normal_tur_file7 = "/Volumes/ThunderBay/JESUS_HAPPYCLOUDS/129/t7_vn_grid.txt";
    normal_tur_file8 = "/Volumes/ThunderBay/JESUS_HAPPYCLOUDS/129/t8_vn_grid.txt";
    normal_tur_file9 = "/Volumes/ThunderBay/JESUS_HAPPYCLOUDS/129/t9_vn_grid.txt";
        #endif
    
        #ifdef HOFFMAN2
            normal_tur_file0 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t0_vn_grid.txt"; ///using k=2-128
            normal_tur_file1 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t1_vn_grid.txt";
            normal_tur_file2 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t2_vn_grid.txt";
            normal_tur_file3 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t3_vn_grid.txt";
            normal_tur_file4 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t4_vn_grid.txt";
            normal_tur_file5 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t5_vn_grid.txt";
            normal_tur_file6 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t6_vn_grid.txt";
            normal_tur_file7 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t7_vn_grid.txt";
            normal_tur_file8 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t8_vn_grid.txt";
            normal_tur_file9 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t9_vn_grid.txt";
    /*
            normal_tur_file10 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t10_vn_grid.txt";
            normal_tur_file11 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t11_vn_grid.txt";
            normal_tur_file12 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t12_vn_grid.txt";
            normal_tur_file13 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t13_vn_grid.txt";
            normal_tur_file14 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t14_vn_grid.txt";
            normal_tur_file15 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t15_vn_grid.txt";
            normal_tur_file16 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t16_vn_grid.txt";
            normal_tur_file17 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t17_vn_grid.txt";
            normal_tur_file18 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t18_vn_grid.txt";
            normal_tur_file19 = "/u/flashscratch/j/jesusms0/TURBULENTFILES_N4/129/t19_vn_grid.txt";
     */
        #endif
    
        #ifdef COMET
            normal_tur_file0 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t0_vn_grid.txt";///using k=2-129
            normal_tur_file1 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t1_vn_grid.txt";
            normal_tur_file2 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t2_vn_grid.txt";
            normal_tur_file3 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t3_vn_grid.txt";
            normal_tur_file4 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t4_vn_grid.txt";
            normal_tur_file5 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t5_vn_grid.txt";
            normal_tur_file6 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t6_vn_grid.txt";
            normal_tur_file7 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t7_vn_grid.txt";
            normal_tur_file8 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t8_vn_grid.txt";
            normal_tur_file9 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t9_vn_grid.txt";
            normal_tur_file9 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t9_vn_grid.txt";
    /*
          normal_tur_file10 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t10_vn_grid.txt";
          normal_tur_file11 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t11_vn_grid.txt";
          normal_tur_file12 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t12_vn_grid.txt";
          normal_tur_file13 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t13_vn_grid.txt";
          normal_tur_file14 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t14_vn_grid.txt";
          normal_tur_file15 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t15_vn_grid.txt";
          normal_tur_file16 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t16_vn_grid.txt";
          normal_tur_file17 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t17_vn_grid.txt";
          normal_tur_file18 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t18_vn_grid.txt";
          normal_tur_file19 = "/oasis/projects/nsf/cla195/jesusms/TURBULENTFILES_N4_HOFF/129/t19_vn_grid.txt";
     */
        #endif
        ...
        if(ThisTask == 0)
        {
            printf("\n-----Allocating turb array----\n");
        }
        
        turb_data_array0 = malloc(sec2 * sizeof(double));
        turb_data_array1 = malloc(sec2 * sizeof(double));
        turb_data_array2 = malloc(sec2 * sizeof(double));
        turb_data_array3 = malloc(sec2 * sizeof(double));
        turb_data_array4 = malloc(sec2 * sizeof(double));
        turb_data_array5 = malloc(sec2 * sizeof(double));
        turb_data_array6 = malloc(sec2 * sizeof(double));
        turb_data_array7 = malloc(sec2 * sizeof(double));
        turb_data_array8 = malloc(sec2 * sizeof(double));
        turb_data_array9 = malloc(sec2 * sizeof(double));
    /*
    turb_data_array10 = malloc(sec2 * sizeof(double));
    turb_data_array11 = malloc(sec2 * sizeof(double));
    turb_data_array12 = malloc(sec2 * sizeof(double));
    turb_data_array13 = malloc(sec2 * sizeof(double));
    turb_data_array14 = malloc(sec2 * sizeof(double));
    turb_data_array15 = malloc(sec2 * sizeof(double));
    turb_data_array16 = malloc(sec2 * sizeof(double));
    turb_data_array17 = malloc(sec2 * sizeof(double));
    turb_data_array18 = malloc(sec2 * sizeof(double));
    turb_data_array19 = malloc(sec2 * sizeof(double));
    */
        file_of_each_grid = malloc(number_of_grids3d * sizeof(int));
        
        
        if(ThisTask == 0)
        {
            create_phys_grid();
            read_turbulence(0, normal_tur_file0);
            read_turbulence(1, normal_tur_file1);
            read_turbulence(2, normal_tur_file2);
            read_turbulence(3, normal_tur_file3);
            read_turbulence(4, normal_tur_file4);
            read_turbulence(5, normal_tur_file5);
            read_turbulence(6, normal_tur_file6);
            read_turbulence(7, normal_tur_file7);
            read_turbulence(8, normal_tur_file8);
            read_turbulence(9, normal_tur_file9);
            /*
            read_turbulence(10, normal_tur_file10);
            read_turbulence(11, normal_tur_file11);
            read_turbulence(12, normal_tur_file12);
            read_turbulence(13, normal_tur_file13);
            read_turbulence(14, normal_tur_file14);
            read_turbulence(15, normal_tur_file15);
            read_turbulence(16, normal_tur_file16);
            read_turbulence(17, normal_tur_file17);
            read_turbulence(18, normal_tur_file18);
            read_turbulence(19, normal_tur_file19);
            */
            printf("-----TURB FILE READ***DONE----\n");
            
            //printf("****Creating initial file assigment to each grid\n");
            //grid_to_file_assignment();
            //printf("****Initial file assigment to each grid-DONE*****\n");
            
            
            printf("\n-----Now Broadcasting----\n");
        }
        
        MPI_Bcast(turb_data_array0, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Bcast(turb_data_array1, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Bcast(turb_data_array2, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Bcast(turb_data_array3, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Bcast(turb_data_array4, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Bcast(turb_data_array5, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Bcast(turb_data_array6, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Bcast(turb_data_array7, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Bcast(turb_data_array8, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Bcast(turb_data_array9, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    /*
    MPI_Bcast(turb_data_array10, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Bcast(turb_data_array11, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Bcast(turb_data_array12, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Bcast(turb_data_array13, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Bcast(turb_data_array14, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Bcast(turb_data_array15, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Bcast(turb_data_array16, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Bcast(turb_data_array17, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Bcast(turb_data_array18, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
    MPI_Bcast(turb_data_array19, sec2, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        */
        DriveFlag = 0;
        ...
        #ifdef SN_ONE_BOX
        SN_BOX1 =  -1 ;// which_file( 1, sn_random) + 1;
        SN_BOX2 =  -1 ;// which_file( 1, sn_random) + 1;
        //SN_BOX3 =  -1 ;// which_file( 1, sn_random) + 1;
        MPI_Bcast(&SN_BOX1, 1, MPI_INT, 0, MPI_COMM_WORLD);
        MPI_Bcast(&SN_BOX2, 1, MPI_INT, 0, MPI_COMM_WORLD);
       // MPI_Bcast(&SN_BOX3, 1, MPI_INT, 0, MPI_COMM_WORLD);
        #endif
    
       #ifdef GRAVITY_GALAXY
    	int ga;
        for (ga=0;ga<number_of_grids;ga++)
        {
            MPI_Bcast(&galactic_grid[ga], sizeof(struct physgrid_box), MPI_BYTE, 0, MPI_COMM_WORLD);
        }
            MPI_Bcast(&galactic_grid_z, sizeof(struct physgrid_box), MPI_BYTE, 0, MPI_COMM_WORLD);
    
         /// SALAS MOD MARCH 21, 2019
        //MPI_Bcast(file_of_each_grid, number_of_grids3d, MPI_INT, 0, MPI_COMM_WORLD);
        ////
        #else
        MPI_Bcast(&cloudgrid, sizeof(struct physgrid), MPI_BYTE, 0, MPI_COMM_WORLD);
        #endif
        ...
        if(ThisTask == 0)
        {
            ...
            printf("\n-----ALL TURBULENT FILES READ, NOW RUNNING GADGET----\n");
        }
