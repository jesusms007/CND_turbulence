  ...
  if(All.ComovingIntegrationOn == 0)
    {
      ...
      for(i = 0; i < NumPart; i++) //// SALAS MOD. FEB 17, 2017
      {
		if(P[i].Ti_endstep == All.Ti_Current)
		{
	    	P[i].GravAccel[0] += (fac * P[i].Pos[0])  ;
	    	P[i].GravAccel[1] += (fac * P[i].Pos[1])  ;
			P[i].GravAccel[2] += (fac * P[i].Pos[2])  ;
    		...
    		{ 
    			...
    			///printf("Gravity = %e, %e, %e\n", total_acc_coord(0, P[100].Pos[0], P[100].Pos[1], P[100].Pos[2]), 
    			//total_acc_coord(1, P[100].Pos[0], P[100].Pos[1], P[100].Pos[2]), 
    			//total_acc_coord(2, P[100].Pos[0], P[100].Pos[1], P[100].Pos[2]) );
    		}
       	 	P[i].GravAccel[0] += total_acc_coord(0, P[i].Pos[0], P[i].Pos[1], P[i].Pos[2]);
         	P[i].GravAccel[1] += total_acc_coord(1, P[i].Pos[0], P[i].Pos[1], P[i].Pos[2]);
         	P[i].GravAccel[2] += total_acc_coord(2, P[i].Pos[0], P[i].Pos[1], P[i].Pos[2]);
